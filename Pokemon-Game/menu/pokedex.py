...
class Pokedex:
    ...
    def select_pokemon_level(self):
        ...
        ''' pokemon vencedor vai armazenar o retorno da batalha, que é um pokémon'''
        ...
        if pokemon_vencedor != None:
            ...
            while replay:
                ...
                if pokemon_evolucao.get_numero_vitorias() < 3:
                    ...
                    '''  Entra no else Número de batalhas é maior que 2, ou seja,  o  jogador já jogou a sua última batalha no level final, completando 3 vitórias '''
                else:
                    print('[bold][green]F I M')
                    break
